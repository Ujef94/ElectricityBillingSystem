    ...
    <form action="{{route('createsss') }}" method="POST">
        ...
        <div class="form">
            <table>
                ...
                <tr class="row">
                    ...
                    <td>
                        <b>Customer Name: </b><input type="text" name="name" placeholder="Enter user Name" value="{{$user->name}}"></input> &nbsp <b style="text-align: right;margin-left: 700px;">Enter Bill Date: </b><input type="date" name="date" placeholder="Enter user Name" value="{{$user->bill_date}}"></input><br>
                ...
                <div id="pricing" class="container">
                    <table class="table table-bordered table-striped text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Reading Date</td>
                                <td><input type="date" name="readingdate" placeholder="Enter Reding Date"value="{{$user->reading_date}}">
                                </td>
                            </tr>
                            <tr>
                                <td>Reading</td>
                                <td class="row4"><input type="number" name="unit" placeholder="Enter Meter Reading" value="{{$user->reading}}"></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <tr class="row7">
            <td>
                <br>
                <div class="amount">
                    <span>Amount :</span><input type="amount" name="amount" placeholder="Enter Amount" value="{{$user->amount}}">
                </div>
